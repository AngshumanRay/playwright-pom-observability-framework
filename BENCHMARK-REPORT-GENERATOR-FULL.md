# Full Source: `scripts/generate-performance-benchmark-report.ts`

> This is the companion file to `PROJECT-BLUEPRINT.md`. Paste the entire content below into `scripts/generate-performance-benchmark-report.ts`.
> This file is ~960 lines and generates the interactive Performance + Accessibility Benchmark Dashboard.
